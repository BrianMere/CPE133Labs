...
HD_PWD='C:/Users/brian/Documents/SchoolPapers/Repositories/CPE133Labs/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_sub_struct.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_sub_struct.tcl
