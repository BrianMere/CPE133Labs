...
HD_PWD='C:/Users/brian/Documents/SchoolPapers/Repositories/CPE133Labs/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_sub_struct.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_sub_struct.tcl -notrace
