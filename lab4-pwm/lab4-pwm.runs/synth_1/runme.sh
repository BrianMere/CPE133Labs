...
HD_PWD='C:/Users/brian/Documents/SchoolPapers/Repositories/CPE133Labs/lab4-pwm/lab4-pwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log max_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source max_counter.tcl
