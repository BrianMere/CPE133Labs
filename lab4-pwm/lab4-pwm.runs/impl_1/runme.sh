...
HD_PWD='C:/Users/brian/Documents/SchoolPapers/Repositories/CPE133Labs/lab4-pwm/lab4-pwm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log max_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source max_counter.tcl -notrace
