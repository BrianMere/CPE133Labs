...
## Switches
set_property PACKAGE_PIN V17 [get_ports {max[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {max[0]}]
set_property PACKAGE_PIN V16 [get_ports {max[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {max[1]}]
set_property PACKAGE_PIN W16 [get_ports {max[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {max[2]}]
set_property PACKAGE_PIN W17 [get_ports {max[3]}]
