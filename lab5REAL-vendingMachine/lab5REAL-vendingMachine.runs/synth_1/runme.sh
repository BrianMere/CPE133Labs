...
HD_PWD='C:/Users/brian/Documents/SchoolPapers/Repositories/CPE133Labs/lab5REAL-vendingMachine/lab5REAL-vendingMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log l5_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source l5_top.tcl
