...
HD_PWD='/home/brianm/Documents/Repos/CPE133Labs/lab5REAL-vendingMachine/lab5REAL-vendingMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log push_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source push_count.tcl
